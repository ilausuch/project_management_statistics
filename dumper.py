...
from bsc.bugzilla_suse import bzmain, bzlist_queries
...
def main():
    ...
    redmine_parser.add_argument('--database', help="SQLite file path", required=True)
    ...
    bsc_parser.add_argument('-l', action='store_true', dest='listqueries', required=False,
                        help='List the metric queries which can be used')
